...
class Roulette extends React.Component {
  ...
  stopRotateWheel() {
    ...
    ctx.fillText(text, baseSize - ctx.measureText(text).width / 2, baseSize / 2);
    ctx.restore();
  ...
  handleOnClick() {
    ...
    setTimeout(() => this.setState({isButtonEnabled : true}), 8000);
    this.spin();
  }
  ...
  render() {
    ...
    return (
      <div className="roulette">
        ...
        <div className="roulette-container">
          <Button disabled={!this.state.isButtonEnabled} onClick={this.handleOnClick} id="spin"> Spin! </Button>
        </div>
      </div>
    );
  }
